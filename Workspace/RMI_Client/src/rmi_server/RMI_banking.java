...
public class RMI_banking extends JFrame {
    ...
    private LoginSyncInterface stub;
    private LoginSyncInterface stubB;
...
//    }
	 ...
	 * Create the frame.
	 */
	public RMI_banking(String username,LoginSyncInterface stub, LoginSyncInterface stubB) {
//		if (System.getSecurityManager() == null) {
//		    System.setSecurityManager(new SecurityManager());
//		}
		this.username = username;
		 this.stub = stub;  // Đảm bảo lưu đối tượng stub từ tham số
		    this.stubB = stubB; 
